...
const BRAND_GRADIENTS: [string, string][] = [
  ...
  [COLORS.mirrorSteel, COLORS.forestDeep],
];
...
export default function ProfileAvatar({
  ...
  const fallbackBg = noPhotoBackground ?? COLORS.brandCharcoal;
  const fallbackInnerBg = noPhotoBackground ?? COLORS.brandCharcoal;
