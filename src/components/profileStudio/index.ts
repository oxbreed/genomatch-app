...
export { default as StudioProgressHeader } from './StudioProgressHeader';
...
export { default as StudioCompletionStrip } from './StudioCompletionStrip';
export { default as StudioSaveDock } from './StudioSaveDock';
export type { StudioSaveState } from './StudioSaveDock';
